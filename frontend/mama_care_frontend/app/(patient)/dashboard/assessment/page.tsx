...
import { getAssessmentHistory, PredictionEntry } from "@/lib/dashboard-data";
import { Activity, Plus, ChevronLeft } from "lucide-react";
import RecentPredictions from "@/components/dashboard/RecentPredictions";

/**
 * Patient Assessment History Page
 */
    ...
    <div style={{ maxWidth: "800px", margin: "0 auto", display: "flex", flexDirection: "column", gap: "2rem" }}>
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        <div style={{ display: "flex", alignItems: "center", gap: "1rem" }}>
          ...
          <div>
            <h1 style={{ fontSize: "1.5rem", fontWeight: 800, color: "#1A1A1A", margin: 0 }}>Assessment History</h1>
            <p style={{ fontSize: "0.9375rem", color: "#6B7280", margin: "0.25rem 0 0 0" }}>Review your past health checks.</p>
          </div>
        </div>

        <Link href="/dashboard/assessment/new" style={{
